...
def song_list():
    ...
    c4 = Button(f2, text="Bhojpuri XD XD", fg='blue',width=12)
    c1.pack(side=TOP)
    c2.pack(side=TOP)
    c3.pack(side=BOTTOM)
    c4.pack(side=BOTTOM)
...
def alb_list():
    ...
    f2 = Frame(a)
    f2.pack(side=RIGHT)
    c1 = Button(f1, text="Whatever", fg='red',width=12)
    c2 = Button(f2, text="You Guys", fg='black',width=12)
    c3 = Button(f1, text="Feel", fg='green',width=12)
    c4 = Button(f2, text="Like", fg='blue',width=12)
    c1.pack(side=TOP)
    c2.pack(side=TOP)
    c3.pack(side=BOTTOM)
    c4.pack(side=BOTTOM)
